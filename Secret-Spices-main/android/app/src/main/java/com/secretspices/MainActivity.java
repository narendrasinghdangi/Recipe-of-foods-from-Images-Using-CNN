...
public class MainActivity extends ReactActivity {
  ...
  /*
    * code added for react-native-screens
    * Added this code, which specifically discards any Activity state persisted during the Activity restart process,
